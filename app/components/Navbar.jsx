    ...
    <div className="flex flex-col">
      <div className="flex justify-between items-center p-5 py-3 md:px-20">
        ...
        <div className="flex gap-3 text-gray-500 ">
          <span className="hover:text-gray-900 text-lg font-medium hover:bg-gray-100 p-2 transition-all duration-200 rounded-full px-4 cursor-pointer">
            Stays
          </span>
          <span className="hover:text-gray-900 text-lg font-medium hover:bg-gray-100 p-2 transition-all duration-200 rounded-full px-4 cursor-pointer">
            Experiences
        ...
        <div className="flex gap-8">
          <div className="flex justify-center items-center font-medium hover:bg-gray-100 cursor-pointer transition-all duration-200 px-3 rounded-full">
            Airclone your home
          </div>
          <LoginModal />
        </div>
      ...
      <div className="flex items-center border-2 md:mx-[200px] shadow-md  rounded-full">
        ...
        <div className="flex w-[34%] hover:bg-gray-200 cursor-pointer transition-all duration-100 py-[10px] pr-5 justify-between rounded-r-full items-center">
          ...
          <button className="bg-[#ff385c] text-white p-3 rounded-full">
            <svg
